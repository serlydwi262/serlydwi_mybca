...
class _MyBCAHomeState extends State<MyBCAHome> {
  ...
  // Data Menu Utama
  final List<Map<String, dynamic>> _mainMenu = [
  ...
  final List<Map<String, dynamic>> _hiddenMenus = [
    ...
    {'i': Icons.business_center_outlined, 'l': 'Produk Bank'}, {'i': Icons.history, 'l': 'Transaksi'},   
  ];
  ...
  void _openBottomSheet() {
    ...
    final allFetures = [..._mainMenus.where((m) => m['l'] != 'Semua'), ..._hiddenMenus];
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: Stack(children: [
      ...
      SafeArea(child: SingleChildScrollView(child: Column(children: [
        _topBar(), _card(), _const SizedBox(height: 20), _gridMenu(), const SizedBox(height: 20), _promo(),
      ]))),
    ]),
